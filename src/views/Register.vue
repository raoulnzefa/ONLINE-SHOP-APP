  ...
  <div class="mt-5 col-md-6 register-card">
    <div>
      <form class="mt-5 card" @submit.prevent="onSubmit">
        <h3 class="h3 mb-5 font-weight-normal">Sign up</h3>
        ...
        />
        <small
          id="inputRegisterPasswordHelpBlock"
          class="form-text text-muted mb-4"
        >Must be at least 8 characters and 1 number</small>
        <input
          type="password"
        ...
        />
        <small
          id="inputRegisterConfirmPasswordHelpBlock"
          class="form-text text-muted mb-4"
        ...
        <div class="custom-control custom-checkbox">
          <input
            ...
            id="inputRegisterAcceptTerms"
            required
          />
          <label
            class="custom-control-label"
            for="inputRegisterAcceptTerms"
